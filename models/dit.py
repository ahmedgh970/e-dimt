...
#################################################################################
def DiT_XL_2(**kwargs):
    return DiT(patch_size=2, hidden_size=1152, num_heads=16, depth=28, **kwargs)

def DiT_L_2(**kwargs):
    return DiT(patch_size=2, hidden_size=1024, num_heads=16, depth=24, **kwargs)

def DiT_B_2(**kwargs):
    return DiT(patch_size=2, hidden_size=768, num_heads=12, depth=12, **kwargs)

def DiT_S_2(**kwargs):
    return DiT(patch_size=2, hidden_size=384, num_heads=6, depth=12, **kwargs)
